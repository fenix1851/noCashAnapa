...
var firstScreen = require("./SliderTwo.webp");

export default function SliderScreenTwo({navigation}) {
        ...
        <View style={styles.wrapper}>
          ...
          <View style={styles.bottom}>
            <View style={styles.bottomText}>
              <Headline style={styles.headline}>Валюта</Headline>
              <Paragraph>
                Жители города приняли решение о создании внутренний валюты по
                названию «Анапки»
              </Paragraph>
            </View>
