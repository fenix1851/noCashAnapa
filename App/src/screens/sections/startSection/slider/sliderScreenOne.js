        ...
        <View style={styles.wrapper}>
          ...
          <View style={styles.bottom}>
            <View style={styles.bottomText}>
              <Headline style={styles.headline}>Сервис «No Cash»</Headline>
              <Paragraph>
                Это сервис по взаиморасчетам на пляже и внутри города. Вам
                больше не нужны наличные на море, наслаждайтесь отдыхом без них
              </Paragraph>
            </View>
