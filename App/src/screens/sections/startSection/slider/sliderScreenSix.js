...
var firstScreen = require("./SliderSix.webp");

export default function SliderScreenSix({ navigation }) {
  return (
    <PaperProvider>
        ...
        <View style={styles.wrapper}>
          ...
          <View style={styles.bottom}>
            <View style={styles.bottomText}>
              <Headline style={styles.headline}>Факты о городе</Headline>
              <Paragraph>
                В этом разделе можно погрузится в историю города и его истории
              </Paragraph>
            </View>
            <View style={styles.bottomNav}>
              ...
              <Button
                ...
                mode="contained"
                onPress={() => {
                  navigation.navigate("SliderScreenSeven");
                }}
              >
                Далее
              </Button>
